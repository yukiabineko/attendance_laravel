            ...
            <ul class="atwork-mobile-lists">
              ...
              <li>
                ...
                <div class="alist-group">
                  <div class="atwork-title">出勤者名</div>
                ...
                <!-- 実労働時間  -->
                <div class="alist-group">
                  <div class="atwork-title">現在実労働時間</div>
                  <div class="atwork-content" id="started_at_{{ $attendance->id }}">{{ date('H:i', strtotime( $attendance->started_at) ) }}</div>
                </div>
                 <!-- 残り時間  -->
                <div class="alist-group">
                  <div class="atwork-title">残り時間</div>
                  <div class="work_times"></div>
                </div>
              </li>
              @endforeach
            </ul>    
